...
static void map_block_major(A2 array2, A2_apply apply, void *cl)
{
	UArray2b_map(array2, (applyfun *) apply, cl);
}

static void map_default(A2 array2, A2_apply apply, void* cl)
{
	map_block_major(array2, apply, cl);
}
...
static void small_map_block_major(A2 a2, A2_smallapply apply,
				  void *cl)
{
...
static void small_map_default(A2 a2, A2_smallapply apply,
	void* cl)
{
	small_map_block_major(a2, apply, cl);
}
